...
<div class="container">
	...
	<div class="row"><?= $column_left; ?>
		...
		<div class="row">
			<div class="col-sm-12 col-md-3 pd-b30" data-aos="fade-up">
				...
				<div>
					...
					<a href="mailto:<?= $store_email; ?>" alt="<?= $store_email; ?>" title="<?= $store_email; ?>" ><?= $store_email; ?></a>
					<?php } ?>
					<br />
					<?php if ($fax) { ?>
					<strong><?= $text_fax; ?></strong><br>
			...
			<div class="col-sm-12 col-md-9 pd-b30" data-aos="fade-up">
