        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
          ...
          <div class="form-group required">
              ...
              <div class="col-sm-10">
                ...
                <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                  <textarea name="title[<?php echo $language['language_id']; ?>]" placeholder="Title" class="form-control"><?php echo isset($title[$language['language_id']]) ? $title[$language['language_id']] : ''; ?></textarea>
                </div>
                <?php } ?>
              </div>
            </div>
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-10">
                <?php foreach ($languages as $language) {  ?>
                <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                  <input type="text" name="mydescription[<?php echo $language['language_id']; ?>]" value="<?php echo isset($mydescription[$language['language_id']]) ? $mydescription[$language['language_id']] : ''; ?>" placeholder="URL" class="form-control" />
                </div>
                <?php } ?>
              </div>
            </div>
          ...
          <div class="form-group required">
              ...
              <div class="col-sm-10">
                <?php foreach ($languages as $language) {  ?>
                <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                  <input type="text" name="myurl[<?php echo $language['language_id']; ?>]" value="<?php echo isset($myurl[$language['language_id']]) ? $myurl[$language['language_id']] : ''; ?>" placeholder="URL" class="form-control" />
                </div>
                <?php } ?>
              </div>
            </div>
          ...
          <div class="form-group required">
              <label class="col-sm-2 text-right">Button Title</label>
              <div class="col-sm-10">
                <?php foreach ($languages as $language) {  ?>
                <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                  <input type="text" name="myurl_title[<?php echo $language['language_id']; ?>]" value="<?php echo isset($myurl_title[$language['language_id']]) ? $myurl_title[$language['language_id']] : ''; ?>" placeholder="URL" class="form-control" />
                </div>
                <?php } ?>
              </div>
            </div>
