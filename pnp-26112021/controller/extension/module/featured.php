...
class ControllerExtensionModuleFeatured extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['myurl'])) {
			$data['myurl'] = $this->request->post['myurl'];
		} elseif (!empty($module_info) && isset($module_info['myurl'])) {
			$data['myurl'] = $module_info['myurl'];
		} else {
			$data['myurl'] = array();
		}

		if (isset($this->request->post['myurl_title'])) {
			$data['myurl_title'] = $this->request->post['myurl_title'];
		} elseif (!empty($module_info) && isset($module_info['myurl_title'])) {
			$data['myurl_title'] = $module_info['myurl_title'];
		} else {
			$data['myurl_title'] = array();
		}

		if (isset($this->request->post['mydescription'])) {
			$data['mydescription'] = $this->request->post['mydescription'];
		} elseif (!empty($module_info) && isset($module_info['mydescription'])) {
			$data['mydescription'] = $module_info['mydescription'];
		} else {
			$data['mydescription'] = array();
		}
