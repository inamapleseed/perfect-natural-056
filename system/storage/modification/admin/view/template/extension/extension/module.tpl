									...
									<td class="text-right">
										...
										<?php if ($extension['installed']) { ?>
											<?php if ($extension['module']) { ?>
												<a href="<?php echo str_replace( 'extension/module/mega_filter', 'module/mega_filter', $extension['edit'] ); ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></a>
												<?php } else { ?>
												<a href="<?php echo str_replace( 'extension/module/mega_filter', 'module/mega_filter', $extension['edit'] ); ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
											<?php } ?>
											<?php } else { ?>
